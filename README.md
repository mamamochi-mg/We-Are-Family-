...
Music Search သည် ယခု `ytsearch20` ဖြင့် result 20 ခုအထိရှာပြီး တစ်မျက်နှာတွင် track 6 ခုစီ ပြသသည်။ Track တစ်ခုချင်း၏ button တွင် နံပါတ်နှင့် title ပါသဖြင့် အကြိုက်မတွေ့သေးလျှင် `Next ▶` ဖြင့် နောက်စာမျက်နှာသို့သွားနိုင်သည်။ `◀ Back` ဖြင့် ယခင်စာမျက်နှာသို့ ပြန်နိုင်ပြီး track ကိုရွေးချယ်ပြီးနောက် artist/channel၊ duration နှင့် title ပါသော detail card ပေါ်လာမည်။ ထိုနေရာတွင် `Download MP3`၊ `Back to Results`၊ `New Search` နှင့် `Home` ကို အသုံးပြုနိုင်သည်။
...
Telegram button callback data သည် အလွန်ရှည်မသွားစေရန် search result များကို server memory ထဲတွင် short token ဖြင့် သိမ်းထားသည်။ အဲဒီအတွက် Railway restart ဖြစ်ပါက ယခင် search result များ ပျောက်သွားမည်ဖြစ်ပြီး user သည် search အသစ်ပြန်လုပ်ရမည်။ Download history ကို အမြဲတမ်းသိမ်းလိုပါက နောက်တစ်ဆင့်တွင် Redis သို့မဟုတ် database ထည့်နိုင်သည်။

## Production upgrade: Admin monitoring and history

User သည် ပထမဆုံး `/start` နှိပ်သောအခါ privacy notice ပြသမည်။ `Agree & Continue` နှိပ်ပြီးမှ bot ကို အသုံးပြုနိုင်မည်။ User ပို့သော supported URL တစ်ခုချင်းစီအတွက် link၊ username ရှိလျှင် `@username`၊ username မရှိလျှင် display name နှင့် Telegram user ID ကို admin monitoring chat သို့ ပို့နိုင်သည်။ Private password၊ cookies သို့မဟုတ် account credentials များကို မပို့ပါ။

Railway Variables တွင် အောက်ပါအတိုင်း ထည့်ပါ။
...
`ADMIN_CHAT_ID` အဖြစ် private admin chat သို့မဟုတ် private group ID ကိုသာ သုံးပါ။ Bot သည် admin group ထဲတွင် member ဖြစ်ရမည်။ `/admin` သည် `ADMIN_USER_IDS` ထဲမှ user များအတွက် statistics dashboard ပြပြီး `/history` သည် user ၏ recent activity ကို ပြသည်။

SQLite data ကို deployment များကြား မပျောက်စေရန် Railway Volume တစ်ခုကို `/app/data` သို့ mount လုပ်ပါ။ Volume မသုံးပါက bot အလုပ်လုပ်သော်လည်း restart/redeploy ပြီးနောက် history နှင့် statistics ပျောက်နိုင်သည်။

> Link monitoring သည် privacy-sensitive feature ဖြစ်သောကြောင့် bot ကို သုံးမည့်သူများအား notice ပြပြီး consent ရယူထားသည်။ Admin access ကို ယုံကြည်ရသော account များတွင်သာ သတ်မှတ်ပါ။

### Included production features

Concurrency guard၊ live progress၊ cancel၊ metadata preview၊ auto-safe temporary cleanup၊ music pagination၊ download history၊ SQLite persistence၊ admin statistics၊ admin link notifications၊ consent gate၊ user allow-list နှင့် timeout/file-size guard တို့ကို project တွင် ထည့်ထားသည်။ Payment-based premium membership နှင့် third-party payment provider integration များသည် provider credentials နှင့် webhook verification လိုအပ်သဖြင့် သီးခြား production integration အဖြစ် ဆက်လုပ်ရမည်။

## Smooth upload optimization

Admin notification ကို user flow မပိတ်ဆို့စေရန် background task အဖြစ် ပြောင်းထားသည်။ Download ပြီးနောက် upload အတွက် Telegram API connection pool နှင့် polling connection pool ကို သီးခြားအသုံးပြုထားပြီး upload timeout ကို သီးခြားသတ်မှတ်နိုင်သည်။ `FAST_UPLOAD_MODE=1` ဖြစ်ပါက video ကို Telegram document အဖြစ်ပို့သည်။ ဤနည်းသည် Telegram ဘက်မှ video processing ကို မစောင့်ဘဲ ဖိုင်ကို ပိုမြန်စွာရောက်စေတတ်သော်လည်း Telegram chat ထဲတွင် inline video player အစား document အဖြစ်မြင်ရနိုင်သည်။ Inline player ကို ဦးစားပေးလိုပါက `FAST_UPLOAD_MODE=0` ထားပါ။

Upload speed အမှန်တကယ်သည် Railway outbound network၊ Telegram API လမ်းကြောင်းနှင့် file size ပေါ်မူတည်သည်။ Bot code သည် network speed ကို အတုလုပ်၍ မမြှင့်နိုင်သော်လည်း admin notification latency၊ connection pool၊ Telegram-side video processing နှင့် timeout-related retry များကို လျှော့ချပေးထားသည်။
